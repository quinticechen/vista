  ...
  return (
    ...
    >
      <svg
        ...
        className="w-full h-auto bg-fill-beige-100" // Use the color prop directly as a class
      >
        ...
        <path
          d="M-80,80 C180,-20 380,140 720,60 C1060,-40 1260,120 1520,40 L1440,160 L-80,160 Z"
        />
      </svg>
      {/* <div 
